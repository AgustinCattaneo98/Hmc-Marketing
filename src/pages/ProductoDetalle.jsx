    ...
    <div className="mx-auto max-w-4xl">
      ...
      <section className="rounded-lg border border-hmc-border bg-hmc-gray3 p-6">
        ...
        <div className="mt-4">
          ...
          <select value={cantidad} onChange={(e) => setCantidad(Number(e.target.value))} className="rounded-md border border-hmc-border bg-hmc-gray2 px-3 py-2 text-sm text-hmc-white outline-none focus:border-hmc-white">
